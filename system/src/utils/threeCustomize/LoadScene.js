...
function loadScene() {
    ...
    let dianlanhuowuArr = [
        {
            id: 'dianlan0001',
            src: 'Model/dianlanhuowu/CK-dianlan0001-HW.png',
            name: '电缆1'
        }, {
            id: 'dianlan0002',
            src: 'Model/dianlanhuowu/CK-dianlan0002-HW.png',
            name: '电缆2'
        }, {
            id: 'dianlan0003',
            src: 'Model/dianlanhuowu/CK-dianlan0003-HW.png',
            name: '电缆3'
        }
    ];
    let longmendiaoArr = [
        {
            id: 'longmendiao0001',
            src: 'Model/longmendiao/CK-longmendiao0001-SB.png',
            name: '龙门吊1'
        }
    ];
    let shexiangtouArr = [
        {
            id: 'shexiangtou0001',
            src: 'Model/shexiangtou/CK-shexiangtou0001-SB.png',
            name: '摄像头1'
        }, {
            id: 'shexiangtou0002',
            src: 'Model/shexiangtou/CK-shexiangtou0002-SB.png',
            name: '摄像头2'
        }, {
            id: 'shexiangtou0003',
            src: 'Model/shexiangtou/CK-shexiangtou0003-SB.png',
            name: '摄像头3'
        }
    ];
    //一起绑定点击事件
